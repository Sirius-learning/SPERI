...
for i in range(0,7):
    ...
    train_dataset = [x_train, m_train, d_train, xpie_train, s_train, t_train]
    dev_dataset = [x_dev, m_dev, d_dev, xpie_dev, s_dev, t_dev]
    test_dataset = [x_test, m_test, d_test, xpie_test, s_test, t_test]
    ...
    print("mae value:",mae)
    print("r2 value:",r2)
    print("+++++++++++++++++++++++++++++++++++++{:.5f}% Finished ++++++++++++++++++++++++++++++++++++++++++++".format(miss_rate*100))
    ...
    file.write('STL_GRUD_traindata10%,point misss,miss rate:{}\n'.format(str(int(miss_rate * 100))))
