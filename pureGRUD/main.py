...
for i in range(0,7):
    ...
    pureGRUD_result_record_path = os.path.join(current_path,"pureGRUD_results_score.txt")
    ...
    train_dataset = [x_train, m_train, d_train, xpie_train]
    dev_dataset = [x_dev, m_dev, d_dev, xpie_dev]
    test_dataset = [x_test, m_test, d_test, xpie_test]
    ...
    file.write('GRUD_traindata10%,point         miss,miss rate:{}\n'.format(str(int(miss_rate * 100))))
