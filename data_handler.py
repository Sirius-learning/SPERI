...
class DataHandler(object):
    ...
    In `fold.npz`:
        ...
        Shape: (n_split, 3)
    """
    def __init__(self, data_path, x, m, d, label_name, max_steps=None, max_timestamp=None):
    ...
    def _get_generator(self, i, shuffle, batch_size, return_targets):
        ...
        # the training fold.
        mean = self._data['mean'][0]
        std = self._data['std'][0]
        folds = len(fold)
